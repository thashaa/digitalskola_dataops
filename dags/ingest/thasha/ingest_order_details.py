...
conn = None
sql = """select * from order_details where order_id in (select order_id from orders where order_date='"""+sys.argv[1]+"""')"""
csv_file_path = '/root/output/thasha/order_details/order_details_'+sys.argv[1]+'.csv'
